  ...
  useEffect(() => {
    ...
    const draw = () => {
      ...
      particles.forEach(p => {
        ...
        ctx.fillStyle = `rgba(43,108,176,${alpha * 0.5})`;
        ctx.fill();
      });
  ...
  return (
    <div>
      <label style={{
        ...
        textTransform: 'uppercase', color: focused ? 'rgb(43,108,176)' : 'rgba(26,54,93,0.6)',
      ...
      <div style={{ position: 'relative' }}>
        <input
          ...
          style={{
            ...
            background: focused ? 'rgba(255,255,255,0.9)' : 'rgba(255,255,255,0.7)',
            border: `1.5px solid ${error ? 'rgb(239,68,68)' : focused ? 'rgb(43,108,176)' : 'rgba(255,255,255,0.6)'}`,
            borderRadius: 10,
            color: 'rgb(26,54,93)',
            fontSize: 13.5,
            fontFamily: 'inherit',
            ...
            boxShadow: focused ? '0 0 0 3px rgba(43,108,176,0.1)' : 'none',
          }}
        />
        {right && (
      ...
      {error && (
        <p style={{ fontSize: 11, color: 'rgb(239,68,68)', marginTop: 4, display: 'flex', alignItems: 'center', gap: 3 }}>
...
export default function Login({ onLogin }) {
  ...
  const strengthColor = ['transparent', 'rgb(239,68,68)', 'rgb(43,108,176)', 'rgb(74,144,226)', 'rgb(34,197,94)'][strength];
      ...
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .ns-bg {
          ...
          background:
            radial-gradient(ellipse 65% 50% at 5% 10%,  rgba(255,255,255,0.5) 0%, transparent 60%),
            radial-gradient(ellipse 55% 60% at 95% 88%,  rgba(43,108,176,0.4) 0%, transparent 58%),
            radial-gradient(ellipse 80% 35% at 50% 102%, rgba(255,255,255,0.15) 0%, transparent 55%);
        }
        .ns-bg::after {
          content: '';
        ...
        .panel-eyebrow {
          ...
          text-transform: uppercase; color: rgb(43,108,176); margin-bottom: 14px;
        }
        .panel-tagline {
          font-family: 'Lora', serif;
          font-size: 34px; font-weight: 600;
          line-height: 1.28; color: rgb(26,54,93);
          letter-spacing: -0.015em;
        }
        .panel-tagline em { font-style: italic; color: rgb(43,108,176); }
        .panel-sub {
          margin-top: 16px; font-size: 13.5px; font-weight: 400;
          color: rgba(26,54,93,0.7); line-height: 1.75;
        }
        .panel-divider {
          width: 44px; height: 3px; border-radius: 2px;
          background: linear-gradient(90deg, rgb(43,108,176), rgb(74,144,226));
          margin: 22px 0;
        }
        .panel-stats { display: flex; gap: 30px; margin-top: 10px; }
        .stat-num {
          font-size: 26px; font-weight: 800; color: rgb(26,54,93); line-height: 1;
        }
        .stat-label {
          font-size: 10.5px; font-weight: 600; color: rgba(26,54,93,0.6);
        ...
        .ns-card-ring {
          ...
          background: linear-gradient(135deg, rgba(43,108,176,0.35), rgba(74,144,226,0.15), rgba(185,226,255,0.4));
        ...
        .ns-card {
          ...
          box-shadow: 0 20px 56px rgba(26,54,93,0.12), 0 4px 14px rgba(26,54,93,0.06), 0 1px 0 rgba(255,255,255,0.95) inset;
          position: relative; overflow: hidden;
        }
        .ns-card::before {
          content: '';
          position: absolute; top: 0; left: 12%; right: 12%; height: 1px;
          background: linear-gradient(90deg, transparent, rgba(74,144,226,0.55), transparent);
        }
        ...
        .logo-img {
          ...
          filter: drop-shadow(0 2px 5px rgba(26,54,93,0.15));
          animation: logoFloat 4s ease-in-out infinite;
        }
        .logo-name {
          font-size: 17px; font-weight: 800; letter-spacing: -0.02em;
          background: linear-gradient(120deg, rgb(26,54,93) 20%, rgb(43,108,176) 100%);
        ...
        .logo-badge {
          ...
          text-transform: uppercase; color: rgba(26,54,93,0.6);
        ...
        .mode-tab.active-login {
          background: linear-gradient(135deg, rgb(43,108,176), rgb(26,54,93));
          color: #ffffff;
          box-shadow: 0 3px 12px rgba(43,108,176,0.3);
        }
        .mode-tab.active-signup {
          background: linear-gradient(115deg, rgb(74,144,226), rgb(43,108,176));
          color: #ffffff;
          box-shadow: 0 3px 14px rgba(74,144,226,0.35);
        }
        .mode-tab:not(.active-login):not(.active-signup):hover {
          color: rgb(26,54,93); background: rgba(255,255,255,0.6);
        }
        ...
        .btn-primary {
          ...
          box-shadow:0 5px 18px rgba(43,108,176,0.3);
        }
        .btn-primary:hover:not(:disabled) {
          background: linear-gradient(to right, rgb(74,144,226), rgb(43,108,176));
          box-shadow:0 8px 26px rgba(74,144,226,0.38);
        ...
        .btn-signup {
          ...
          position:relative; overflow:hidden;
          transition:all .28s cubic-bezier(.16,1,.3,1);
          box-shadow:0 5px 18px rgba(74,144,226,0.28);
        }
        .btn-signup:hover:not(:disabled) {
          background: linear-gradient(115deg, rgb(43,108,176), rgb(26,54,93));
          box-shadow:0 8px 26px rgba(43,108,176,0.3);
          transform:translateY(-2px);
        }
        ...
        .alert-ok  { background:rgba(34,197,94,0.1); border:1px solid rgba(34,197,94,0.3); color:rgb(34,197,94); }
        .alert-err { background:rgba(239,68,68,0.1);  border:1px solid rgba(239,68,68,0.3); color:rgb(239,68,68); }

        .forgot-link {
          text-align:right; margin-top:8px;
          font-size:12px; color:rgb(43,108,176); cursor:pointer; font-weight:500;
          transition:color .18s;
        }
        .forgot-link:hover { color:rgb(26,54,93); }
        ...
        .footer-dot  { width:3px; height:3px; border-radius:50%; background:rgba(43,108,176,0.4); }
        .footer-text { font-size:10.5px; color:rgba(26,54,93,0.6); letter-spacing:.1em; text-transform:uppercase; font-weight:500; }

        .eye-btn {
          background:none; border:none; cursor:pointer;
          color:rgb(43,108,176); display:flex; align-items:center;
          transition:color .2s;
        }
        .eye-btn:hover { color:rgb(26,54,93); }
        ...
        input::placeholder { color:rgba(26,54,93,0.28); }
        input:-webkit-autofill {
          -webkit-box-shadow:0 0 0 100px rgba(230,245,247,.95) inset !important;
          -webkit-text-fill-color:rgb(26,54,93) !important;
        }
      `}</style>
                    ...
                    <div className="strength-wrap">
                      {[1,2,3,4].map(i => (
                        <div 
                          ...
                          style={{ background: strength >= i ? strengthColor : 'rgba(185,226,255,0.5)' }}
                        />
                      ))}
                    </div>
                  )}
